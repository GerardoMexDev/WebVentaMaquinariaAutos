...
export const CATEGORIES: CategoryMeta[] = [
  {
    ...
    desc: "Excavadoras, cargadores frontales y rodillos con stock real en Lima. Equipos listos para entrar a obra, con garantía de fábrica y soporte técnico certificado en campo.",
    color: "#f5a623",
    colorDeep: "#d18a0b",
    image: IMG.loader,
  },
  {
    ...
    desc: "Tractores de 75 a 165 HP y cosechadoras de alto rendimiento para campaña grande o pequeña. Financiamiento agrícola con cronograma alineado a tu cosecha.",
    color: "#7c9a45",
    colorDeep: "#55702a",
    image: IMG.tractor,
  },
  {
    ...
    desc: "Pickups 4x4, SUV y vehículos para flota corporativa con entrega inmediata, bono de flotero y mantenimiento programado incluido en la primera revisión.",
    color: "#4e7fa0",
    colorDeep: "#33617f",
    image: IMG.pickup,
  },
...
export const PRODUCTS: Product[] = [
  /* ----------------------------- MAQUINARIA VIAL ----------------------------- */
  {
    ...
    image: IMG.excavator,
    badge: "Más vendida",
    specs: ["20.5 t", "145 HP", "Balde 1.2 m³", "Cabina ROPS"],
    ficha: [
      { k: "Motor", v: "Cat C4.4 turbodiésel, Tier 3" },
      { k: "Profundidad de excavación", v: "6.72 m" },
      { k: "Garantía", v: "3 años / 6,000 h (tremie)" },
      { k: "Entrega", v: "Inmediata desde patio Lima" },
    ],
  },
  {
    id: "v-sy215",
    ...
    image: IMG.excavator,
    flip: true,
    specs: ["21.5 t", "158 HP", "Balde 1.0 m³", "Mandos hidráulicos"],
    ficha: [
      { k: "Motor", v: "Mitsubishi 4M50, 4 cilindros" },
      { k: "Alcance máximo", v: "9.95 m" },
      { k: "Garantía", v: "5 años / 10,000 h en tren de fuerza" },
      { k: "Entrega", v: "Inmediata, stock 3 unidades" },
    ],
  },
  {
    id: "v-950gc",
    ...
    specs: ["18.4 t", "222 HP", "Balde 3.1 m³", "4x4"],
    ficha: [
      { k: "Motor", v: "Cat C7.1 ACERT" },
      { k: "Carga de vuelco", v: "9.8 t" },
      { k: "Garantía", v: "2 años / 4,000 h" },
      { k: "Entrega", v: "15 días, en tránsito a Lima" },
    ],
  },
  {
    id: "v-wa320",
  ...
  },
  {
    ...
    price: 98500,
    image: IMG.roller,
    specs: ["11.0 t", "130 HP", "Pata de cabra", "Vibración dual"],
    ficha: [
      { k: "Motor", v: "Cat C4.4" },
  ...
  /* --------------------------- MAQUINARIA AGRÍCOLA --------------------------- */
  {
    ...
    image: IMG.tractor,
    badge: "Más vendido",
    specs: ["110 HP", "4WD", "PowrQuad 24/24", "Cabina cerrada"],
    ficha: [
      { k: "Motor", v: "PowerTech 4.5 L, 4 cilindros" },
      { k: "Levante trasero", v: "5,400 kg" },
      { k: "Garantía", v: "3 años / 1,500 h" },
      { k: "Entrega", v: "Inmediata, stock 5 unidades" },
    ],
  },
  {
    id: "a-t7190",
    ...
    image: IMG.tractor,
    flip: true,
    specs: ["165 HP", "4WD", "Full Powershift", "Suspensión de cabina"],
    ficha: [
      { k: "Motor", v: "NEF 6.7 L, Stage IIIA" },
      { k: "Transmisión", v: "18x6 Full Powershift" },
      { k: "Garantía", v: "2 años / 1,200 h" },
      { k: "Entrega", v: "Inmediata desde patio Lima" },
    ],
  },
  {
  ...
  },
  {
    ...
    image: IMG.harvester,
    badge: "Bajo pedido",
    specs: ["373 HP", "Plataforma 35 ft", "Rotor doble", "Monitor Gen 4"],
    ficha: [
      { k: "Motor", v: "PowerTech 9.0 L" },
      { k: "Tanque de grano", v: "10,600 L" },
      { k: "Garantía", v: "2 años / 900 h" },
      { k: "Entrega", v: "60 días, cupo de campaña" },
    ],
  },
  {
    id: "a-4130",
  ...
  },
  {
    ...
    price: 46900,
    image: IMG.tractor,
    specs: ["75 HP", "4WD", "SyncShuttle 12/12", "TDF 540/540E"],
    ficha: [
      { k: "Motor", v: "PowerTech 2.9 L / 4 cilindros" },
      { k: "Levante trasero", v: "2,500 kg" },
      { k: "Garantía", v: "3 años / 1,500 h" },
      { k: "Entrega", v: "Inmediata, plan agro con cuotas semestrales" },
    ],
  },
  ...
  /* ------------------------------- AUTOS ------------------------------- */
  {
    ...
    ficha: [
      ...
      { k: "Garantía", v: "5 años / 150,000 km" },
  ...
  },
  {
    ...
    image: IMG.pickup,
    flip: true,
    specs: ["2.0 Bi-Turbo 210 HP", "4x4", "Automática 10 vel", "Pantalla 12\""],
    ficha: [
      { k: "Motor", v: "EcoBlue 2.0 L Bi-Turbo" },
      { k: "Capacidad de carga", v: "1,050 kg" },
      { k: "Garantía", v: "5 años / 150,000 km" },
      { k: "Entrega", v: "Inmediata, 2 colores en stock" },
    ],
  },
  {
    id: "c-dmax",
  ...
  },
  {
    ...
    price: 52400,
    image: IMG.suv,
    specs: ["2.8 TD 204 HP", "4x4", "7 asientos", "Automática"],
    ficha: [
...
export const TESTIMONIALS = [
  {
    quote:
      "Compramos dos excavadoras 320 GC y la tercera llegó con el financiamiento aprobado en 48 horas. El taller respondió en campo la misma semana que tuvimos una alerta. Así da gusto trabajar.",
    name: "Ricardo Salas",
  ...
  {
    quote:
      "El tractor 6110M llegó antes de la campaña y el asesor nos capacitó a los operadores sin costo. Las cuotas quedaron calzadas con la cosecha, tal como lo prometieron.",
    name: "María Campos",
    role: "Administradora",
  ...
  {
    quote:
      "Renovamos la flota con ocho Hilux. Bono de flotero real, entrega programada y mantenimiento sin sorpresas. Terramak se ganó un cliente de largo plazo.",
    name: "Jorge Paredes",
